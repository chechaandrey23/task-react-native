        ...
        <View style={{marginTop: 10}}>
          <Carousel
            ...
            renderItem={({index, item}) => {
              return (<View key={index+1} style={styles.imageCarouselView}>
        		<Image style={styles.imageCarouselImage} source={{uri: item.url}} />
      		  </View>);
              /*
              return (
              	<LongPressGestureHandler key={index+1}>
              	  <Animated.View testID={"carousel1"} key={index+1} index={index} style={{flex: 1}}>
